_base_ = [
    '../_base_/models/mask_rcnn_r50_fpn_1_classes.py',
...
train_pipeline = [
    ...
    dict(type='LoadAnnotations', with_bbox=True, with_mask=False), ## CAMBIO FALSE AQUI
    ...
    dict(type='Collect', keys=['img', 'gt_bboxes', 'gt_labels']), #QUITO GT_MAKS
]
...
data = dict(
    samples_per_gpu = 1, #CAMBIO BATCH SIZE
    train=dict(
