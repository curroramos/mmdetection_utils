...
pretrained = 'https://dl.fbaipublicfiles.com/convnext/convnext_tiny_1k_224_ema.pth' # PONGO THIS
...
train_pipeline = [
    ...
    dict(type='LoadAnnotations', with_bbox=True, with_mask=False), #CAMBIO EL WITH MASK
